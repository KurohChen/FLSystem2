  ...
  <div class="container" v-loading="loading">
    ...
    <div class="content">
      <div class="page" id="page1" v-if="active==0">
        <el-row :gutter="24">
          <el-col :span="10">
            <el-form ref="form1_1" :model="form1.input1" size="small" label-width="100px">
              <h1>gNB网络参数输入</h1>
          ...
          <el-col :span="10" :offset="2">
            <el-form ref="form1_2" :model="form1.input2" size="small" label-width="100px">
              <h1>UE网络参数输入</h1>
              <el-form-item label="用户名" prop="username">
      ...
      <div class="page" id="page2" v-if="active==1">
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form ref="form2_1" :model="form2" size="small" label-width="100px">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form ref="form2_2" :model="form2" size="small" label-width="100px">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form ref="form2_3" :model="form2" size="small" label-width="100px">
